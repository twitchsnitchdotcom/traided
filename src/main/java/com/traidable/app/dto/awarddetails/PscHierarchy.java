...
public class PscHierarchy {
    ...
    @JsonProperty("subtier_code")
    public SubtierCode getSubtierCode() {
        return subtierCode;
    }

    @JsonProperty("subtier_code")
    public void setSubtierCode(SubtierCode subtierCode) {
        this.subtierCode = subtierCode;
    }
